# Contribute to Paid Memberships Pro - Variable Pricing
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-variable-pricing/issues/new/choose)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-variable-pricing.git` to set the upstream repo
